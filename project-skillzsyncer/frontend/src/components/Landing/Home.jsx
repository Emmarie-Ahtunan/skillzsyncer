    ...
    <>
        <section className="bg-white py-20">
            <div className="container mx-auto flex flex-col items-center justify-center text-center">
                ...
                <p className="text-lg mb-8">
                    Discover the features and benefits of our product that will
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        ...
                        <p className="text-gray-600">
                            A brief description of the first feature that highlights its
                            benefits.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        ...
                        <p className="text-gray-600">
                            A brief description of the second feature that highlights its
                            benefits.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        ...
                        <p className="text-gray-600">
                            A brief description of the third feature that highlights its
                            benefits.
                        </p>
                    </div>
                </div>
        ...
        <section className="bg-blue-600 py-20">
            <div className="container mx-auto text-center text-white">
                ...
                <p className="text-lg mb-8">
                    Sign up now and start your journey with our amazing product.
                </p>
